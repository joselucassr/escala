...
INSERT INTO `usuarios` (`id`, `usuario`, `cpf`, `presenca`, `senha`, `email`, `valor`, `voluntario`) VALUES
(1, 'admin', '999.999.999-99', 2, '0192023a7bbd73250516f069df18b500', 'admin@email.com', 0, 0);
